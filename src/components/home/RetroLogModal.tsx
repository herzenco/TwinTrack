...
import { DEFAULT_BOTTLE_FEED_TYPE, DIAPER_LOG_OPTIONS, FEED_AMOUNT_PRESETS, PAST_BREAST_SIDE_OPTIONS } from '../../utils/loggingRules';

type RetroActivityType = 'bottle' | 'breast' | 'diaper';
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-text-secondary">Dirty diapers only</p>
            </div>
          </button>
        </div>
      )}
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-3">
            ...
            {DIAPER_LOG_OPTIONS.map((option) => (
              <button
                key={option.subtype}
                onClick={() => handleLogDiaper(option.subtype)}
